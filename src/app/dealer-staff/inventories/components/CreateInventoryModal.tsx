              ...
              <div className="bg-gray-50 rounded-2xl p-6 space-y-5">
                ...
                <div className="group">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="select-focus-ring w-full px-5 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-white text-gray-700 font-medium appearance-none cursor-pointer hover:border-purple-300"
                  >
