...
interface UpdateFormCustomerProps {
  customerId: string;
  isOpen: boolean;
  fullName: string;
  ...
  handleSubmit: (id: string, dob: string) => void; // <--- nhận id từ modal, dob optional
  onClose: () => void;
}

const UpdateFormCustomer: React.FC<UpdateFormCustomerProps> = ({
  customerId,
  isOpen,
  fullName,
  setFullName,
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    // Nếu dob rỗng, giữ nguyên dob cũ
    const finalDob = dob as string; // undefined để backend giữ giá trị hiện tại
    handleSubmit(customerId, finalDob);
    onClose();
  };
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        ...
        <div className="flex min-h-screen items-center justify-center p-4">
          <div className="modal-content relative bg-white rounded-3xl shadow-2xl w-full max-w-3xl transform">
            ...
            <div className="absolute top-0 left-0 right-0 h-48 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-t-3xl overflow-hidden">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm font-medium mt-1">
                      Chỉnh sửa và lưu thay đổi thông tin
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="bg-gradient-to-br from-gray-50 to-indigo-50 rounded-2xl p-6 space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`input-focus w-full px-5 py-3.5 border-2rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all bg-white text-gray-700 font-medium hover:border-indigo-300`}
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className={`input-focus w-full px-5 py-3.5 border-2rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all bg-white text-gray-700 font-medium hover:border-orange-300 resize-none`}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`input-focus w-full px-5 py-3.5 border-2rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-all bg-white text-gray-700 font-medium hover:border-pink-300`}
                  />
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">
                      Vui lòng kiểm tra kỹ thông tin trước khi lưu. Các thay đổi
                      sẽ được cập nhật vào hệ thống ngay lập tức.
                    </p>
                  </div>
                </div>
              </div>
