      ...
      <td className="px-3 py-2.5 whitespace-nowrap">
        <div className="flex items-center gap-2 group">
          ...
          <div>
            ...
            <div className="text-[9px] text-gray-500 font-medium">Khách hàng</div>
          </div>
        </div>
      </td>
      ...
      <td className="px-3 py-2.5 whitespace-nowrap">
        <div className="flex items-center gap-2 group">
          ...
          <div>
            ...
            <div className="text-[9px] text-gray-500 font-medium">Nhân viên</div>
          </div>
        </div>
      </td>
      ...
      <td className="px-3 py-2.5 whitespace-nowrap">
        <div className="flex items-center justify-center gap-1.5">
          ...
          <button
            ...
            className="group relative p-2 bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white rounded-lg transition-all duration-200 hover:scale-110 active:scale-95 shadow-md hover:shadow-lg"
            title="Xóa đơn hàng"
          >
