            ...
            return (
              ...
              >
                ...
                <div className="mb-4">
                  <span
                    className={`${
                      getStatus(car.status).color
                    } text-white px-3 py-1.5 rounded-lg text-xs font-semibold inline-block shadow-md`}
                  >
                  ...
                  {selectedCarData.map((car) => (
                    ...
                    >
                      <span
                        className={`${
                          getStatus(car.status).color
                        } text-white px-4 py-2 rounded-lg text-xs font-semibold inline-block shadow-md`}
                      >
                        {getStatus(car.status).label}
                      </span>
                    </td>
