...
const menuItems: MenuItem[] = [
  { icon: <FaCar />, label: "Danh mục xe", path: "/dealer-manager/cars" },
  {
    icon: <Boxes />,
    label: "Quản lý kho",
    path: "/dealer-manager/inventories"
  },
  {
    icon: <Package />,
    label: "Quản lý báo giá",
    path: "/dealer-manager/quotation"
  },
  {
    icon: <FileText />,
    label: "Quản lý hợp đồng",
    path: "/dealer-manager/contract"
  },
  {
    icon: <FaBoxOpen />,
  ...
  },
  {
    ...
    path: "/dealer-manager/dealerOrder"
  },
  {
    icon: <HiUserGroup />,
    label: "Quản lý khách hàng",
    path: "/dealer-manager/customer"
  },
  // {
  //   icon: <FaBuilding />,
  //   label: "Quản lý đại lý",
  //   path: "/dealer-manager/dealerView"
  // }
  {
    icon: <Home size={20} color="#ffffff" />, // size và màu tùy chỉnh
    label: "Quản lý tài khoản đại lý",
    path: "/dealer-manager/accountDealer"
  },
  {
    ...
    <div className="flex bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 min-h-screen overflow-hidden">
            ...
            <div className="flex items-center gap-3 animate-fadeIn">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-100">
                  {String(profile.role) === "DEALER_MANAGER"
                    ? `${profile.dealerName}`
                    : "Quản lý đại lý"}
                </p>
              </div>
      ...
      >
        ...
        <header
          ...
          style={{
            left: isSidebarOpen ? "20rem" : "5rem",
            width: isSidebarOpen ? "calc(100% - 19rem)" : "calc(100% - 5rem)"
          }}
        >
          <div>
          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-2xl overflow-hidden z-50 border border-emerald-200 animate-fadeIn">
                ...
                {/* <button
                  onClick={() => {
                    router.push("/dealer-manager/profile");
